...
app.post('/commentSubmit', upload.single('commentImg'), function (req, res) {
	...
	conn.query(sql, params, function (error, results) {
		...
		var sql =
			"select id,pid,userName,email,indexUrl,avatarUrl,time,content,contentImg,sticky,sys,browser from userComment where pid=? order by sticky desc,time desc,id desc";
...
app.post('/commentSubmit2', upload.single('commentImg'), function (req, res) {
	...
	conn.query(sql, params, function (error, results) {
		...
		var sql =
			"select id,cid,userName,email,toNick,toId,indexUrl,avatarUrl,time,content,contentImg,sys,browser from commentInner where cid=? order by time desc,id desc";
...
app.post('/boardSubmit2', upload.single('commentImg'), function (req, res) {
	...
	conn.query(sql, params, function (error, results) {
		...
		//////////////////////////////////////////////////
		var sql =
			"select id,cid,userName,email,toNick,toId,indexUrl,avatarUrl,time,content,contentImg from boardInner where cid=? order by time desc,id desc";
		var parms = req.body.id;
		conn.query(sql, parms, function (error, results) {
			if (error) {
				console.log(error);
...
app.get('/queryboard', function (req, res) {
	var sql = "select id,time,content,contentImg,sticky from board order by sticky desc,time desc,id desc";
	conn.query(sql, function (error, results) {
		if (error) {
			console.log(error);
			return;
